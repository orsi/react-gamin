...
const useAudio = (src?: string) => {
  ...
  fetch(src)
    ...
    .then((_audioBuffer) => (audioBuffer = _audioBuffer));
  ...
  // listen for 'click' event to resume a suspended AudioContext
  useEffect(() => {
...
const useKey = (target: string, listener: () => void, continuous = false) => {
